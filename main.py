...
for proxy in proxy_list:
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            rmb = requests.get('https://gist.githubusercontent.com/khaykov/a6105154becce4c0530da38e723c2330/raw/41ab415ac41c93a198f7da5b47d604956157c5c3/gistfile1.txt', proxies=proxies, timeout=5)
